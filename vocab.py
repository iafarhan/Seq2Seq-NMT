...
class VocabEntry(object):
    ...
    def to_input_tensor_char(self, sents: List[List[str]], device: torch.device) -> torch.Tensor:
        ...
        sent_char_indicies = self.words2charindices(sents) # list of list of list of char indicies
        ...
        padded_sents = pad_sents_char(sents=sent_char_indicies,char_pad_token=self.char_pad) #batch_size,list of max_sent_len
        sents_var = torch.tensor(padded_sents,device=device)
        batch_size,max_sent,max_char = sents_var.shape
